...
public class CommandeClientApplication {
    ...
    public void onPostDeploy(PostDeployEvent event) {
        ...
        vars.put("paiementEnLigne", true);
        vars.put("paiementValide", true);
        vars.put("status", "EN_COURS");

        runtimeService.startProcessInstanceByKey("Process_CommandeClient", vars);
        System.out.println("🚀 Processus 'Process_CommandeClient' démarré avec les variables : " + vars);
    }
}
